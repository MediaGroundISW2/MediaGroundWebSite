...
class PromocioneController extends Controller
{
    ...
    public function create()
    {
        ...
        $contenido = Contenido::pluck('nombre_contenido','id');
        return view('promocione.create', compact('promocione','contenido'));
    }
    ...
    public function edit($id)
    {
        $promocione = Promocione::find($id);
        $contenido = Contenido::pluck('nombre_contenido','id');
        return view('promocione.edit', compact('promocione','contenido'));
    }
